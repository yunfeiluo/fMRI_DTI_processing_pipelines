...
class Res34Encoder(nn.Module):
    def __init__(self, begin_channel, num_classes=0):
        super(Res34Encoder, self).__init__()
...
class Res34Decoder(nn.Module):
    def __init__(self, end_channel): # 91*109*91
        super(Res34Decoder, self).__init__()
...
class Res34Autoencoder(nn.Module):
    def __init__(self, begin_channel):
        super(Res34Autoencoder, self).__init__()
        print('Building Autoencoder with ResNet34 structure...')
        self.encoder = Res34Encoder(begin_channel)
        self.decoder = Res34Decoder(begin_channel)
